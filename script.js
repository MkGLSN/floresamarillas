...
// Iniciar movimiento del puntero después de 400ms
window.setTimeout(() => {
    pointer.x = .7;
    pointer.y = .5;
    pointer.moved = true;
...
// Mover el cursor y actualizar la posición del puntero
...
// Alternar el dibujo con el click
...
// Limpieza de pantalla con el botón o la tecla de espacio
...
// Función de renderizado y actualización de la animación
function render() {
